                ...
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="flex-shrink-0">
                        <a href="/" class="text-2xl font-bold text-white flex items-center">
                            <img src="/src/theme-aquiesportes/assets/Logo.webp" width="180" height="104" alt="Aquiesportes" title="Aquiesportes" class="h-[6.5rem] w-auto max-h-full" fetchpriority="high">
                        </a>
                    </div>
...
useHead({
    ...
    link: [
        ...
        },
        {
            rel: 'icon',
            type: 'image/ico',
            href: '/src/theme-aquiesportes/favicon.ico?v=3'
        },
