...
onMounted(() => {
    // Precarregar imagem do autor se disponível - apenas no cliente
    if (typeof window !== 'undefined') {
        ...
        // Precarregar primeira imagem de post se disponível
        if (authorPosts.value && authorPosts.value.length > 0) {
            const firstPost = authorPosts.value[0];
